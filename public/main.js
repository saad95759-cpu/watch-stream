...
function initRoom(roomId) {
  ...
  function loadSource(source, type, time, isPlaying) {
    ...
    if (type === "youtube") mountYouTube(source, time, isPlaying);
    else if (type === "hls") mountHls(source, time, isPlaying);
    else if (type === "dash") mountDash(source, time, isPlaying);
    else mountMp4(source, time, isPlaying);
  }
